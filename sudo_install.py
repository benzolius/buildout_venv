...
# If Red Hat family and package ends with 'dev', extend package name with 'el'
if family == REDHAT:
    package_list = package_list + [''.join((package, 'el')) for package in package_list if package.endswith('dev')]
    package_list = [package for package in package_list if not package.endswith('dev')]
